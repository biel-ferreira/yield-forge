...
port + ingestion worker), SPEC-101 (investor profile). Next: SPEC-102 (portfolio) /
SPEC-103 (dashboard). See [docs/02-specs/README.md](docs/02-specs/README.md) for the live index.
