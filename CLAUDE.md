...
SPEC-103 (dashboard), SPEC-104 (AI insight engine), SPEC-105 (AI rebalancing assistant). Next:
SPEC-106 (health score) / SPEC-107 (projections) / SPEC-108 (conversational copilot). See
