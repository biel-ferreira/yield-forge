...
func routeTable(api apiHandler, authH authHandler, profileH profileHandler, holdingsH holdingsHandler, dashboardH dashboardHandler, insightsH insightsHandler, rebalancingH rebalancingHandler) []route {
	return []route{
